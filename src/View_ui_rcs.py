...
class Ui_View(object):
    def setupUi(self, View):
        ...
        self.actionClearAll = QtWidgets.QAction(View)
        ...
        self.menuOptionen.addAction(self.actionClearAll)
    ...
    def retranslateUi(self, View):
        ...
        self.actionClearAll.setText(_translate("View", "Clear all"))
        self.actionClearAll.setToolTip(_translate("View", "Erstelle ein neues Bild"))
