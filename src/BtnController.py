...
from commands.CmdSetStrengthColor import *
...
class BtnController(QObject):  # windowListener, ActionListener
    ...
    def __init__(self, view, cvModel, grafikModel):
        ...
        # Color
        self.red = CmdSetRedColor(self.view, self.cvModel)
        self.black = CmdSetBlackColor(self.view, self.cvModel)
        self.yellow = CmdSetYellowColor(self.view, self.cvModel)
        self.green = CmdSetGreenColor(self.view, self.cvModel)
        self.blue = CmdSetBlueColor(self.view, self.cvModel)
        self.white = CmdSetWhiteColor(self.view, self.cvModel)
        # Strength
        self.slim = CmdSetStrengthSlim(self.view, self.cvModel)
        self.medium = CmdSetStrengthMedium(self.view, self.cvModel)
        self.big = CmdSetStrengthBig(self.view, self.cvModel)
    ...
    def registerCommands(self):
        ...
        self.commandInvoker.addCommand(self.btnRot, self.red)
        self.commandInvoker.addCommand(self.btnGruen, self.green)
        self.commandInvoker.addCommand(self.btnBlau, self.blue)
        self.commandInvoker.addCommand(self.btnGelb, self.yellow)
        self.commandInvoker.addCommand(self.btnWeiss, self.white)
        self.commandInvoker.addCommand(self.btnSchwarz, self.black)
        self.commandInvoker.addCommand(self.btnDick, self.big)
        self.commandInvoker.addCommand(self.btnMittel, self.medium)
        self.commandInvoker.addCommand(self.btnDuenn, self.slim)
